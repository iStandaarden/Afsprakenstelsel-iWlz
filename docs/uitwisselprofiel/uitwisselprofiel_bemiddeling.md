...
In het artikel [Randvoorwaarden](../organisatiebeleid/randvoorwaarden.md) is aangegeven welke wet- en regelgeving voor het Bemiddelingsregister van toepassing is.
...
Het proces toeleiden en bewaken passende zorg is beschreven in het Artikel Proces. Zie [Procesmodel > 5. Zorgkantoor: Toeleiden, bewaken passende zorg](../proces/procesmodel.md#5-zorgkantoor-toeleiden-bewaken-passende-zorg)

**5.2 Proces dossieroverdracht**

Het proces dossieroverdracht is beschreven in het Artikel Proces. Zie [Procesmodel > 5.4 Dossieroverdracht](../proces/procesmodel.md#6-zorgkantoor-dossieroverdracht)
