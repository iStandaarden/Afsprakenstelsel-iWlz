...
In de jaren daarna heeft VWS de Nationale Visie en Strategie (NVS) uitgewerkt. Het Actieprogramma iWlz sluit daar bij aan, door zich onder andere te conformeren aan de [generieke functies](./achtergrond_toelichting.md#32-generieke-functies), zodra die gereed zijn voor gebruik in het kader van plateau 2 van deze visie. Ook sluit het programma aan bij de ontwikkelingen van het landelijk vertrouwensstelsel (Twiin-LVS) zoals hieronder verder toegelicht.
