...
!!! success "**Concrete invulling**"
    ...
    - Informatie-niveau: In het afsprakenstelsel is een generieke regelset opgenomen. Deze regelset beschrijft op informatieniveau de regels waaraan alle uit te wisselen gegevens dienen te voldoen. Zie hoofdstuk [Informatie](../informatie/index.md).
    - Informatie-niveau: Per register is een register-specifieke gegevensset in het afsprakenstelsel opgenomen. Deze beschrijft op informatie-niveau welke gegevens door het register worden aangeboden. Zie hoofdstuk [Uitwisselprofielen](../uitwisselprofiel/index.md) .
    - Data-niveau: In het afsprakenstelsel worden per dienst de specificaties van de technische koppelvlakken beschreven. Zie hoofdstuk [Applicatie](../applicatie/index.md).
...
!!! info "BRON: CONCRETISERING ARCHITECTUUR"
